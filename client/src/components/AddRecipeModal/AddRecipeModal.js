      ...
      <div className="modal-body">
        ...
        <form>
            ...
            <div className ="row grains-1">
                <div className ="col-sm-6">
                    <div className="form-group">
                        ...
                        <select className="form-control" value={props.grainName1} name="grainName1" onChange={props.onChange} id="grains-select1">
                            <option></option>
            ...
            <div className ="row grains-2">
                <div className ="col-sm-6">
                    <div className="form-group">
                        <select className="form-control" name="grainName2" value={props.grainName2} onChange={props.onChange} id="grains-select2">
                        <option></option>
                        {/* Takes the grain array which should contain the list of grains contained in inventory and creates an option for each */}
                        {props.grains.map(grain => (
                                <option key={grain.name}>{grain.name}</option>
                ...
                <div className ="col-sm-6">
                    <div className="form-group">
                        <input type="number" name="grainAmt2" value={props.grainAmt2} onChange={props.onChange} className="form-control" id="grains-amt2" />
                    </div>
                </div>
            </div>
            ...
            <div className ="row grains-3">
                <div className ="col-sm-6">
                    <div className="form-group">
                        <select className="form-control" value={props.grainName3} name="grainName3" onChange={props.onChange} id="grains-select3">
                        <option></option>
                       {/* Takes the grain array which should contain the list of grains contained in inventory and creates an option for each */}
                        {props.grains.map(grain => (
                                <option key={grain.name}>{grain.name}</option>
                ...
                <div className ="col-sm-6">
                    <div className="form-group">
                        <input type="number" name="grainAmt3" value={props.grainAmt3} onChange={props.onChange} className="form-control" id="grains-amt3" />
                    </div>
                </div>
            </div>
            ...
            <div className ="row grains-2">
                <div className ="col-sm-6">
                    <div className="form-group">
                        <select className="form-control" name="grainName4" value={props.grainName4} onChange={props.onChange} id="grains-select4">
                        <option></option>
                        {/* Takes the grain array which should contain the list of grains contained in inventory and creates an option for each */}
                        {props.grains.map(grain => (
                                <option key={grain.name}>{grain.name}</option>
                ...
                <div className ="col-sm-6">
                    <div className="form-group">
                        <input type="number" name="grainAmt4" value={props.grainAmt4} onChange={props.onChange} className="form-control" id="grains-amt4" />
                    </div>
                </div>
            </div>
